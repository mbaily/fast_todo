...
function $() {
  for (var n4, u4, t5, r4, o4, f4, c4, s4 = 1; i.length; ) i.length > s4 && i.sort(e), n4 = i.shift(), s4 = i.length, n4.__d && (t5 = void 0, r4 = void 0, o4 = (r4 = (u4 = n4).__v).__e, f4 = [], c4 = [], u4.__P && ((t5 = d({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(t5), O(u4.__P, t5, r4, u4.__n, u4.__P.namespaceURI, 32 & r4.__u ? [o4] : null, f4, null == o4 ? S(r4) : o4, !!(32 & r4.__u), c4), t5.__v = r4.__v, t5.__.__k[t5.__i] = t5, N(f4, t5, c4), r4.__e = r4.__ = null, t5.__e != o4 && C(t5)));
  $.__r = 0;
}
function I(n4, l4, u4, t5, i4, r4, o4, e4, f4, c4, s4) {
  var a4, h5, y5, w5, d4, g4, _4, m4 = t5 && t5.__k || v, b3 = l4.length;
  for (f4 = P(u4, l4, m4, f4, b3), a4 = 0; a4 < b3; a4++) null != (y5 = u4.__k[a4]) && (h5 = -1 == y5.__i ? p : m4[y5.__i] || p, y5.__i = a4, g4 = O(n4, y5, h5, i4, r4, o4, e4, f4, c4, s4), w5 = y5.__e, y5.ref && h5.ref != y5.ref && (h5.ref && B(h5.ref, null, y5), s4.push(y5.ref, y5.__c || w5, y5)), null == d4 && null != w5 && (d4 = w5), (_4 = !!(4 & y5.__u)) || h5.__k === y5.__k ? f4 = A(y5, f4, n4, _4) : "function" == typeof y5.type && void 0 !== g4 ? f4 = g4 : w5 && (f4 = w5.nextSibling), y5.__u &= -7);
  return u4.__e = d4, f4;
}
...
function O(n4, u4, t5, i4, r4, o4, e4, f4, c4, s4) {
  var a4, h5, p5, v4, y5, _4, m4, b3, S2, C3, M2, $2, P2, A3, H, L2, T3, j3 = u4.type;
  if (null != u4.constructor) return null;
  128 & t5.__u && (c4 = !!(32 & t5.__u), o4 = [f4 = u4.__e = t5.__e]), (a4 = l.__b) && a4(u4);
  n: if ("function" == typeof j3) try {
    if (b3 = u4.props, S2 = "prototype" in j3 && j3.prototype.render, C3 = (a4 = j3.contextType) && i4[a4.__c], M2 = a4 ? C3 ? C3.props.value : a4.__ : i4, t5.__c ? m4 = (h5 = u4.__c = t5.__c).__ = h5.__E : (S2 ? u4.__c = h5 = new j3(b3, M2) : (u4.__c = h5 = new x(b3, M2), h5.constructor = j3, h5.render = E), C3 && C3.sub(h5), h5.props = b3, h5.state || (h5.state = {}), h5.context = M2, h5.__n = i4, p5 = h5.__d = true, h5.__h = [], h5._sb = []), S2 && null == h5.__s && (h5.__s = h5.state), S2 && null != j3.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = d({}, h5.__s)), d(h5.__s, j3.getDerivedStateFromProps(b3, h5.__s))), v4 = h5.props, y5 = h5.state, h5.__v = u4, p5) S2 && null == j3.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), S2 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
    else {
    ...
    h5.state = h5.__s, null != h5.getChildContext && (i4 = d(d({}, i4), h5.getChildContext())), S2 && !p5 && null != h5.getSnapshotBeforeUpdate && (_4 = h5.getSnapshotBeforeUpdate(v4, y5)), L2 = a4, null != a4 && a4.type === k && null == a4.key && (L2 = V(a4.props.children)), f4 = I(n4, w(L2) ? L2 : [L2], u4, t5, i4, r4, o4, e4, f4, c4, s4), h5.base = u4.__e, u4.__u &= -161, h5.__h.length && e4.push(h5), m4 && (h5.__E = h5.__ = null);
  } catch (n5) {
...
function q(u4, t5, i4, r4, o4, e4, f4, c4, s4) {
  var a4, h5, v4, y5, d4, _4, m4, b3 = i4.props, k3 = t5.props, x3 = t5.type;
  ...
  if (null == x3) b3 === k3 || c4 && u4.data == k3 || (u4.data = k3);
    ...
    for (a4 in k3) d4 = k3[a4], "children" == a4 ? y5 = d4 : "dangerouslySetInnerHTML" == a4 ? h5 = d4 : "value" == a4 ? _4 = d4 : "checked" == a4 ? m4 = d4 : c4 && "function" != typeof d4 || b3[a4] === d4 || j(u4, a4, d4, b3[a4], o4);
    ...
    c4 || (a4 = "value", "progress" == x3 && null == _4 ? u4.removeAttribute("value") : null != _4 && (_4 !== u4[a4] || "progress" == x3 && !_4 || "option" == x3 && _4 != b3[a4]) && j(u4, a4, _4, b3[a4], o4), a4 = "checked", null != m4 && m4 != u4[a4] && j(u4, a4, m4, b3[a4], o4));
  }
  return u4;
}
function B(n4, u4, t5) {
...
function CalendarOccurrence({ occurrence }) {
  ...
  const [completed, setCompleted] = d2(occurrence.completed || false);
  const [phantom, setPhantom] = d2(occurrence.phantom || false);
  ...
  async function handleUnignore(e4) {
    e4.preventDefault();
  ...
  async function handleComplete(e4) {
  ...
  const itemLink = occurrence.item_type === "todo" ? `/html_no_js/todos/${occurrence.id}` : `/html_no_js/lists/${occurrence.id}`;
  return html`
...
function initCalendar(containerId, initialOccurrences) {
  const container = document.getElementById(containerId);
  if (!container) {
    console.error("Calendar container not found:", containerId);
    return;
  }
  G(html`<${CalendarApp} initialOccurrences="${initialOccurrences}" />`, container);
}
export {
  CalendarApp,
  CalendarOccurrence,
