...
@pytest.mark.parametrize(
    "month,day,created,expected_year",
    [
        (
            1,
            2,
        ...
        (
            2,
            29,
            datetime(2028, 3, 1, tzinfo=timezone.utc),
            None,
        ),
...
@pytest.mark.parametrize(
    "month,day,window_start,window_end,expected_years",
    [
        ...
        (
            ...
            datetime(2032, 12, 31, tzinfo=timezone.utc),
            [],
        ),
        ...
        (
            ...
            29,
            datetime(2027, 1, 1, tzinfo=timezone.utc),
            datetime(2028, 12, 31, tzinfo=timezone.utc),
            [],
        ),
    ],
)
